...
<article>
<h1>회원 탈퇴</h1>
<form action="memberdelPro.jsp" id="join" method="post" name="frm">
<fieldset>
<legend>Member Delete</legend>
<label>User ID</label><input type="text" name="id" value="<%=bean.getId() %>"  readonly><br>
...
<input type="reset" value="이전" class="cancel">
