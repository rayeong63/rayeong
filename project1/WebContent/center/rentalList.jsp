...
<%
	String result11 = request.getParameter("result");
	if (!(result11 == null || result11.equals(""))) {
		%><p>도서반납 성공했습니다.</p><%
	}
%>
...
if (totalRowCount > 0) {	
    ...
    <td><%=rent.getBrend() %></td>
    <td>
    	<form action="rentaldeletePro.jsp">
    		<input type="hidden" name="num" value="<%=rent.getNum() %>">
    		<input type="submit" value="반납">
    	</form>
    	<!--  <input type="button" value="반납" onclick="location.href='rentaldeletePro.jsp?num=<%=rent.getNum() %>'">-->
    </td>
    </tr>
		<%
	}
